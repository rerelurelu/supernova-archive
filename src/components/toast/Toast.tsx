...
export const Toast = component$<ToastProps>((props) => {
  ...
  const offset = useComputed$(() => actualToastIndex.value * GAP + previousToastHeights.value);
  ...
  useTask$(({ track }) => {
    ...
    props.state.heights = [{ toastId: toast.id, height: newHeight }, ...props.state.heights];
  });
